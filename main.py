...
for i in desired_runs:
    ...
    # Configure decision times directly in the script (no env var override)
    decision_times = [0, 5, 40, 80, 130, 180, 230]

    t = TreeModel(decision_times=decision_times, prob_scale=1.0)
